...
const str1 = 'apple';
bloomFilter.hash1(str1);
bloomFilter.hash2(str1);
bloomFilter.hash3(str1);
console.log(bloomFilter.hash1(str1));
console.log(bloomFilter.hash2(str1));
console.log(bloomFilter.hash3(str1));
