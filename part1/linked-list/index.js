...
list.append("2 Node");
list.append("3 Node");
console.log("append 3 Nodes: "  + list.toString());
list.prepend("0 Node");
console.log("prepend Node: " + list.toString());
list.reverse();
console.log("reverse():" + list.toString());
const arrayList = list.toArray();
console.log("toArray():");
console.log(arrayList);
list.remove("2 Node");
console.log("remove('2 Node'):" + list.toString());
list.insert("4 Node", 2);
console.log("insert('4 Node', 2):" + list.toString());
list.removeHead();
console.log("removeHead():" + list.toString());
list.removeTail();
console.log("removeTail():" + list.toString());
console.log(list.find({value:"4 Node"}));